...
CoffeeGrinder is a PHP wrapper for CoffeeScript:http://jashkenas.github.com/coffee-script/ compilers. It's useful to dynamically compiling CoffeeScript on the server-side before serving to a client (as opposed to manually compiling scripts).
